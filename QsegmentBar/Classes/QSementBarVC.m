...
#import "QSementBarVC.h"
#import "UIView+QSegmentBar.h"

@interface QSementBarVC ()<QSegmentBarDelegate, UIScrollViewDelegate>
...
@implementation QSementBarVC
- (QSegmentBar *)segmentBar {
    if (!_segmentBar) {
        QSegmentBar *segmentBar = [QSegmentBar segmentBarWithFrame:CGRectZero];
